...
public class OrppleAI : MonoBehaviour {

	public GameObject appleProjectile;				// what I will throw at the player
	public GameObject orangeProjectile;				// what I will throw at the player
	...
	public float chaseFor = 5f;					// how long I chase after runaway enemies (the player) for
	...
	public float minRange = 5f;				// how close I can be and still be able to attack the player
	public float maxRange = 30f;				// how far I can be and still be able to attack the player
	...
	void Update () {
		...
		anim.SetFloat ("HowClose", distance);
	}
	...
	void Throw ()
	{
		...
		if (distance < 2 * minRange) {
			// set what I am going to throw
			newProjectile = (GameObject)Instantiate (orangeProjectile, gameObject.transform.position
				+ Vector3.up * 0.5f + facing * 2.0f, transform.localRotation);
		} else {
			newProjectile = (GameObject)Instantiate (appleProjectile, gameObject.transform.position
			                                         + Vector3.up * 0.5f + facing * 2.0f, transform.localRotation);
		}
