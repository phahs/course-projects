...
// this is how all enemy oranges will behave
public class OrangeAI : MonoBehaviour {
	...
	public float chaseFor = 3f;					// how long I chase after runaway enemies (the player) for
	...
	public float maxRange = 15f;				// how far I can be and still be able to attack the player
